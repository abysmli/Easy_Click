...
module.exports = function(app) {
  ...
  app.get('/information/:catagory', function(req, res) {
    Shops.getList_expire(req.params.catagory, "", 0, 15, function(err, shops) {
      if (err) {
        shops = [];
      }
  ...
  app.post('/information/get_catagory', function(req, res) {
    if(typeof(req.body.index)==='undefined') {
      ...
      if (req.body.key==="")
      {
        ...
        Shops.getList_expire(mIndex, req.body.key, req.body.skip, req.body.limit, function(err, shops) {
          if (err) {
            shops = [];
          }
  ...
  app.get('/information/:catagory/:details', function(req, res) {
    Shops.getbyUid(req.params.details, function(err, shop) {
      if (err) {
        req.flash('error', err);
  ...
  app.get('/remove_information_buffer', function(req, res) {
    Shops_buffer.remove(function(err) {
      if (err) {
        req.flash('error', err);
        return res.redirect('/background/information');
      }
  ...
  app.get('/remove_information/:uid', function(req, res) {
    Shops.removebyUid(req.params.uid, function(err) {
      if (err) {
        req.flash('error', err);
  ...
  app.get('/remove_information_buffer/:uid', function(req, res) {
    Shops_buffer.removebyUid(req.params.uid, function(err) {
      if (err) {
        req.flash('error', err);
        return res.redirect('/background/information');
      }
  ...
  app.get('/user_post_view', function(req, res) {
    Posts.getAll('', 0, 15, function(err, posts) {
      if (err) {
        posts = [];
      }
  ...
  app.get('/user_post_view/:details', function(req, res) {
    Posts.getbyUid(req.params.details, function(err, post) {
      if (err) {
        req.flash('error', err);
  ...
  app.post('/user_post_view/post_list', function(req, res) {
    Posts.getAll(req.body.key, req.body.skip, req.body.limit, function(err, posts) {
      if (err) {
        posts = [];
      }
  ...
  app.get('/remove_post/:uid', function(req, res) {
    Posts.removebyUid(req.params.uid, function(err) {
      if (err) {
        req.flash('error', err);
  ...
  app.get('/remove_post_buffer', function(req, res) {
    Posts_buffer.remove(function(err) {
      if (err) {
        req.flash('error', err);
        return res.redirect('/background/user_post');
      } else {
  ...
  app.get('/remove_post_buffer/:uid', function(req, res) {
    Posts_buffer.removebyUid(req.params.uid, function(err) {
      if (err) {
        req.flash('error', err);
        return res.redirect('/background/user_post');
      }
  ...
  app.get('/news', function(req, res) {
    News.getAll(0, 15, function(err, news) {
      if (err) {
        req.flash('error', err);
  ...
  app.get('/news/:uid', function(req, res) {
    News.getbyUid(req.params.uid, function(err, news) {
      if (err) {
        req.flash('error', err);
        return res.redirect('/news');
      }
  ...
  app.get('/remove_news/:uid', function(req, res) {
    News.removebyUid(req.params.uid, function(err) {
      if (err) {
        req.flash('error', err);
        return res.redirect('/background/news');
      }
  ...
  app.get('/learning/:catagory/:uid', function(req, res) {
    Learn.getbyUid(req.params.uid, function(err, learn) {
      var mTitle;
  ...
  app.get('/learning/:learning', function(req, res) {
    Learn.getbyIndex(req.params.learning, function(err, learns) {
      if (err) {
        req.flash('error', err);
  ...
  app.get('/remove_learnings/:uid', function(req, res) {
    Learn.removebyUid(req.params.uid, function(err) {
      if (err) {
        req.flash('error', err);
        return res.redirect('/background/learning');
      }
  ...
  app.get('/message-box', function(req, res) {
    if (req.session.user) {
      Messages.getbyUsername(req.session.user.name, function(err, messages) {
        if (err) {
          messages = [];
        }
  ...
  app.get('/remove_messages/:uid', function(req, res) {
    Messages.removebyUid(req.params.uid, function(err) {
      if (err) {
        req.flash('error', err);
        return res.redirect('/message-box');
      }
  ...
  app.get('/background/news', function(req, res) {
    News.getAll(0, 0, function(err, news) {
  ...
  app.post('/background/news/:uid', function(req, res) {
    var news = new News("", req.body.title, req.body.sub_title, req.body.source, req.body.sourceurl, req.body.newsdate, req.body.content, utils.getImageString(req.files.previmg), utils.getImageString(req.files.img));
    news.modifybyUid(req.params.uid, function(err) {
      if (err) {
        req.flash('error', err);
        return res.redirect('/background/news');
      }
  ...
  app.get('/background/information', function(req, res) {
    Shops_buffer.getAll(function(err, shops) {
      if (err) {
        shops = [];
      }
  ...
  app.post('/background/information_post', function(req, res, next) {
    ...
    shop.save(function(err) {
      ...
      Shops_buffer.setHandled(req.params.uid, function(err) {
        if (err) {
          req.flash('error', err);
          return res.redirect('/background/information_editor_list');
        }
  ...
  app.get('/background/information/:uid', function(req, res) {
    Shops_buffer.getbyUid(req.params.uid, function(err, shop) {
      if (err) {
        req.flash('error', err);
        return res.redirect('/background/information');
      }
  ...
  app.get('/background/information_editor/:uid', function(req, res) {
    Shops.getbyUid(req.params.uid, function(err, shop) {
      if (err) {
        req.flash('error', err);
        return res.redirect('/background/information_editor_list');
      }
  ...
  app.get('/background/information_editor_list_searcher', function(req, res, next) {
    Shops.getbyTele(req.query.search_key, function(err, shop) {
      if (err) {
        req.flash('error', err);
        return res.redirect('/background/information_editor_list/');
      }
  ...
  app.get('/background/user_post', function(req, res) {
    Posts_buffer.getAll(function(err, posts) {
      if (err) {
        posts = [];
      }
  ...
  app.post('/background/user_post_post', function(req, res, next) {
    ...
    post.save(function(err) {
      ...
      Posts_buffer.setHandled(req.params.uid, function(err) {
        if (err) {
          req.flash('error', err);
          return res.redirect('/background/user_post_editor_list');
        }
  ...
  app.get('/background/user_post/:uid', function(req, res) {
    Posts_buffer.getbyUid(req.params.uid, function(err, post) {
      if (err) {
        req.flash('error', err);
        return res.redirect('/background/user_post');
      }
  ...
  app.get('/background/user_post_editor_list', function(req, res) {
    Posts.getAll('', 0, 0, function(err, posts) {
      if (err) {
        posts = [];
      }
  ...
  app.get('/background/user_post_editor/:uid', function(req, res) {
    Posts.getbyUid(req.params.uid, function(err, post) {
      if (err) {
        req.flash('error', err);
        return res.redirect('/background/user_post_editor_list');
      }
  ...
  app.post('/background/user_post_editor/:uid', function(req, res, next) {
    var post = new Posts(req.body.username, req.body.title, req.body.content, req.body.location, req.body.contact, req.body.price, req.body.tags, req.body.prevtext, req.body.prevtext2, utils.getImageString(req.files.previmage), utils.getImageString(req.files.image));
    post.modifybyUid(req.params.uid, function(err) {
      if (err) {
        req.flash('error', err);
        return res.redirect('/background/user_post');
      }
  ...
  app.get('/background/user_post_editor_list_searcher', function(req, res, next) {
    Posts.getbyTele(req.query.search_key, function(err, post) {
      if (err) {
        req.flash('error', err);
        return res.redirect('/background/user_post_editor_list/');
      }
  ...
  app.get('/background/learning', function(req, res) {
    Learn.getAll(function(err, learns) {
      if (err) {
        req.flash('error', err);
        return res.redirect('/background/learning');
      }
  ...
  app.post('/background/learning/:uid', function(req, res, next) {
    ...
    learn.modifybyUid(req.params.uid, function(err) {
      if (err) {
        req.flash('error', err);
        return res.redirect('/background/learning');
      }
  ...
  app.post('/app_user_remove_post', function(req, res) {
    Posts.removebyUid(req.body.uid, function(err) {
      if (err) {
        var data = {
          result: "error",
          message: err
